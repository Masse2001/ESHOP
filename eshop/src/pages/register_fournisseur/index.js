...
const RegisterF = () => {
    ...
    function handleSubmit(e) {
        ...
        {
            axios.post('http://localhost:80/shop-api/register_fournisseur.php',formData)
            .then(res=>
                {
                    if(res.data == "ce mail existe déjà")
                    {
                        window.confirm(formData.email_fournisseur+" est un mail déjà existant, retentez avec un autre mail")
