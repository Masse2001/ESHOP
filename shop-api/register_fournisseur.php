...
switch($method) {
    case "POST" :
        ...
        $sql = "INSERT INTO fournisseur(email_fournisseur, mdp, nom, prenom, adresse, age, sexe, tel, conf,date_creation,name_society)
                VALUES
                (:email_fournisseur, :mdp, :nom, :prenom, :adresse, :age, :sexe, :tel, :conf,:date_creation,:name_society)";
        ...
        $stmt->bindParam(':name_society', $user->name_society);
        $query = "SELECT * FROM fournisseur where email_fournisseur = '$user->email_fournisseur'";
        ...
        if ($result)
        {
            ...
            else
            {
                    if($stmt->execute()) {
                        ...
                        echo "Account Fournissor created successfully";
                        

                    } else {
                        echo "Failed to create account Fournissor";
                    }
            }       
